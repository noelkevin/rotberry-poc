...
echo neko;                sudo ufw allow proto tcp from 192.168.0.0/16 to 192.168.0.0/16 port 3333 comment 'neko'
echo neko;                sudo ufw allow proto udp from 192.168.0.0/16 to 192.168.0.0/16 port 33300:33305 comment 'neko'
