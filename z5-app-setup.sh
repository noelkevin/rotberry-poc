...
sudo openssl req -x509 -new -nodes -key self-ca.key -sha256 -days 3650 -out self-ca.crt \
  -subj "/C=US/ST=California/L=San Francisco/O=rotberry/OU=rotberry/CN=MacBook-Pro.local"
...
&& bzip2 -d restic_0.18.0_linux_arm64.bz2; rm restic_0.18.0_linux_arm64.bz2
